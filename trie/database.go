...
type Database struct {
	diskdb gdtudb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb gdtudb.KeyValueStore) *Database {
...
func (db *Database) DiskDB() gdtudb.KeyValueStore {
	return db.diskdb
}
...
// are referenced toggdtuer by database itself.
...
func (db *Database) commit(hash common.Hash, batch gdtudb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
