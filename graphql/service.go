...
func New(stack *node.Node, backend gdtuapi.Backend, cors, vhosts []string) error {
	if backend == nil {
...
func newHandler(stack *node.Node, backend gdtuapi.Backend, cors, vhosts []string) error {
	q := Resolver{backend}
