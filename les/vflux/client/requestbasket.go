...
// up by basketFactor because of the exponential expiration of lgdtu-term statistical data.
...
//
// Values are gradually transferred to the global reference basket with a lgdtu time
// constant so that each server basket represents lgdtu term usage and price statistics.
