...
func NewBalanceTracker(ns *nodestate.NodeStateMachine, setup BalanceTrackerSetup, db gdtudb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *BalanceTracker {
