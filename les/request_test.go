...
type accessTestFn func(db gdtudb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db gdtudb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db gdtudb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db gdtudb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db gdtudb.Database, bhash common.Hash, num uint64) light.OdrRequest {
