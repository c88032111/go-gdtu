...
func (b *LesApiBackend) ChainConfig() *params.ChainConfig {
	return b.gdtu.chainConfig
}

func (b *LesApiBackend) CurrentBlock() *types.Block {
	return types.NewBlockWithHeader(b.gdtu.BlockChain().CurrentHeader())
}
...
func (b *LesApiBackend) HeaderByNumber(ctx context.Context, number rpc.BlockNumber) (*types.Header, error) {
	if number == rpc.LatestBlockNumber || number == rpc.PendingBlockNumber {
		return b.gdtu.blockchain.CurrentHeader(), nil
	}
	return b.gdtu.blockchain.GetHeaderByNumberOdr(ctx, uint64(number))
}
...
func (b *LesApiBackend) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return b.gdtu.blockchain.GetBlockByHash(ctx, hash)
}
...
func (b *LesApiBackend) BlockByNumberOrHash(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash) (*types.Block, error) {
	...
	if hash, ok := blockNrOrHash.Hash(); ok {
		...
		if blockNrOrHash.RequireCanonical && b.gdtu.blockchain.GetCanonicalHash(block.NumberU64()) != hash {
			return nil, errors.New("hash is not currently canonical")
		}
		return block, nil
	}
...
func (b *LesApiBackend) StateAndHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (*state.StateDB, *types.Header, error) {
	...
	return light.NewState(ctx, header, b.gdtu.odr), header, nil
}
...
func (b *LesApiBackend) GetReceipts(ctx context.Context, hash common.Hash) (types.Receipts, error) {
	if number := rawdb.ReadHeaderNumber(b.gdtu.chainDb, hash); number != nil {
		return light.GetBlockReceipts(ctx, b.gdtu.odr, hash, *number)
	}
	return nil, nil
}
...
func (b *LesApiBackend) GetLogs(ctx context.Context, hash common.Hash) ([][]*types.Log, error) {
	if number := rawdb.ReadHeaderNumber(b.gdtu.chainDb, hash); number != nil {
		return light.GetBlockLogs(ctx, b.gdtu.odr, hash, *number)
	}
	return nil, nil
}
...
func (b *LesApiBackend) GetTd(ctx context.Context, hash common.Hash) *big.Int {
	if number := rawdb.ReadHeaderNumber(b.gdtu.chainDb, hash); number != nil {
		return b.gdtu.blockchain.GetTdOdr(ctx, hash, *number)
	}
	return nil
}
...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header) (*vm.EVM, func() error, error) {
	...
	return vm.NewEVM(context, txContext, state, b.gdtu.chainConfig, vm.Config{}), state.Error, nil
}
...
func (b *LesApiBackend) GetPoolTransactions() (types.Transactions, error) {
	return b.gdtu.txPool.GetTransactions()
}

func (b *LesApiBackend) GetPoolTransaction(txHash common.Hash) *types.Transaction {
	return b.gdtu.txPool.GetTransaction(txHash)
}
...
func (b *LesApiBackend) ProtocolVersion() int {
	return b.gdtu.LesVersion() + 10000
}
...
func (b *LesApiBackend) StateAtBlock(ctx context.Context, block *types.Block, reexec uint64) (*state.StateDB, func(), error) {
	return b.gdtu.stateAtBlock(ctx, block, reexec)
}
...
func (b *LesApiBackend) StatesInRange(ctx context.Context, fromBlock *types.Block, toBlock *types.Block, reexec uint64) ([]*state.StateDB, func(), error) {
	return b.gdtu.statesInRange(ctx, fromBlock, toBlock, reexec)
}
...
func (b *LesApiBackend) StateAtTransaction(ctx context.Context, block *types.Block, txIndex int, reexec uint64) (core.Message, vm.BlockContext, *state.StateDB, func(), error) {
	return b.gdtu.stateAtTransaction(ctx, block, txIndex, reexec)
}
