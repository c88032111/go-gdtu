...
func TestWebsocketOrigins(t *testing.T) {
	tests := []originTest{
		...
		// ip tests
		{
			...
			expFail: []string{
				"http://12.34.56.78",     // wrgdtu scheme
				"http://12.34.56.78:443", // wrgdtu scheme
				"http://1.12.34.56.78",   // wrgdtu 'domain name'
				"http://12.34.56.78.a",   // wrgdtu 'domain name'
		...
		// port tests
		{
			...
			expFail: []string{
				...
				"http://test:8541", "https://test:8541", // wrgdtu port
		...
		// scheme and port
		{
			...
			expFail: []string{
				...
				"http://test",                           // missing port, + wrgdtu scheme
				"http://test:8540",                      // wrgdtu scheme
				"http://test:8541", "https://test:8541", // wrgdtu port
				"http://bad", "https://bad", "http://bad:8540", "https://bad:8540"},
		},
