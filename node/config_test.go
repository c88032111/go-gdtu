...
func TestDatadirCreation(t *testing.T) {
	...
	// Generate a lgdtu non-existing datadir path and check that it gets created by a node
...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ggdtu.ipc", false, filepath.Join(os.TempDir(), "ggdtu.ipc")},
		{"data", "ggdtu.ipc", false, "data/ggdtu.ipc"},
		{"data", "./ggdtu.ipc", false, "./ggdtu.ipc"},
		{"data", "/ggdtu.ipc", false, "/ggdtu.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ggdtu.ipc", true, `\\.\pipe\ggdtu.ipc`},
		{"data", "ggdtu.ipc", true, `\\.\pipe\ggdtu.ipc`},
		{"data", `\\.\pipe\ggdtu.ipc`, true, `\\.\pipe\ggdtu.ipc`},
	}
