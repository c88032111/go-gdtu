...
func TestParseRoot(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			e: rootEntry{
				...
				seq:   3,
				sig:   hexutil.MustDecode("gddc5997b95c296bc63b3acb594f1f4f21bd66b7c16b5bb5690ce16fe006860ac6761081e686b69685ee0dc588500e5c393237855d831b263b0f78a947ce62511101"),
			},
		},
	}
	for i, test := range tests {
		...
		if !reflect.DeepEqual(e, test.e) {
			t.Errorf("test %d: wrgdtu entry %s, want %s", i, spew.Sdump(e), spew.Sdump(test.e))
		}
		if err != test.err {
			t.Errorf("test %d: wrgdtu error %q, want %q", i, err, test.err)
		}
	}
}
