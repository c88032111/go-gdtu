...
// starting nodes and connecting them toggdtuer.
//
...
// Connect connects two nodes toggdtuer by calling the "admin_addPeer" RPC
...
func (n *Node) UnmarshalJSON(raw []byte) error {
	...
	// Ticket: https://github.com/gdtuersphere/go-gdtu/issues/1177
	var node struct {
		Config *adapters.NodeConfig `json:"config,omitempty"`
		Up     bool                 `json:"up"`
	}
...
// lgdturunning tests may need a lgdtuer timeout
