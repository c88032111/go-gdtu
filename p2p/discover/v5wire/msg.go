...
func (*Pgdtu) Name() string             { return "PGDTU/v5" }
func (*Pgdtu) Kind() byte               { return PgdtuMsg }
func (p *Pgdtu) RequestID() []byte      { return p.ReqID }
func (p *Pgdtu) SetRequestID(id []byte) { p.ReqID = id }
