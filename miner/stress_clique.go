...
func main() {
	...
	for _, sealer := range sealers {
		...
		stack, gdtuBackend, err := makeSealer(genesis)
		if err != nil {
			panic(err)
		}
		defer stack.Close()
...
func makeSealer(genesis *core.Genesis) (*node.Node, *gdtu.Gdtu, error) {
	...
	// Start the node and configure a full Gdtu node on it
