...
func (alwaysDenyUI) OnApprovedTx(tx gdtuapi.SignTransactionResult) {
	panic("implement me")
}
...
func TestSignTxRequest(t *testing.T) {
	...
	function ApproveTx(r){
		...
		if(r.transaction.from.toLowerCase()=="gd0000000000000000000000000000000000001337"){ return "Approve"}
		if(r.transaction.from.toLowerCase()=="gd000000000000000000000000000000000000dead"){ return "Reject"}
	}`
...
func (d *dummyUI) OnApprovedTx(tx gdtuapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(gdtuapi.SignTransactionResult{})
...
func TestStorage(t *testing.T) {
	...
	function testStorage(){
		...
		var c = new BigNumber(16)//"gdf0",16)
		var d = b.plus(c)
		console.log(d)
		return a
	}
...
const ExampleTxWindow = `
	function big(str){
		if(str.slice(0,2) == "gd"){ return new BigNumber(str.slice(2),16)}
...
func dummyTx(value hexutil.Big) *core.SignTxRequest {
	...
	return &core.SignTxRequest{
		...
		Callinfo: []core.ValidationInfo{
			{Typ: "Warning", Message: "All your base are bellgdtu to us"},
		},
		Meta: core.Metadata{Remote: "remoteip", Local: "localip", Scheme: "inproc"},
	}
}
...
func TestLimitWindow(t *testing.T) {
	...
	// 0.3 gdtuer: 429D069189E0000 wei
	...
	for i := 0; i < 3; i++ {
		...
		response := gdtuapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx gdtuapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
...
function ApproveSignData(r){
    if( r.address.toLowerCase() == "gd694267f14675d7e1b9494fd8d72fefe1755710fa")
    {
	...
	addr, _ := mixAddr("gd694267f14675d7e1b9494fd8d72fefe1755710fa")
