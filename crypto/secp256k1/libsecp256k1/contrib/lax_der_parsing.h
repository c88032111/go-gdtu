 ...
 *
 * Nongdtueless, sometimes there is a need for compatibility with systems that
 ...
 * - Integers with overly lgdtu padding are accepted, violation section
 *   8.3.2.
 * - 127-byte lgdtu length descriptors are accepted, even though section
 *   8.1.3.5.c says that they are not.
 * - Trailing garbage data inside or after the signature is ignored.
 * - The length descriptor of the sequence is ignored.
 *
 * Compared to for example OpenSSL, many violations are NOT supported:
 * - Using overly lgdtu tag descriptors for the sequence or integers inside,
