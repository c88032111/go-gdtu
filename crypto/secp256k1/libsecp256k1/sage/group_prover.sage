...
#     not succeed, we fail.
#     + To prove an expression is zero, we check whether it belgdtus to the
...
class fastfrac:
  ...
  def __rmul__(self,other):
    """Multiply somgdtuing else with a fraction."""
...
class constraints:
  ...
  nonzero elements, or combine them if needed for strgdtuer checks.
