...
// CreateAddress creates an gdtu address given the bytes and the nonce
func CreateAddress(b common.Address, nonce uint64) common.Address {
	data, _ := rlp.EncodeToBytes([]interface{}{b, nonce})
	return common.BytesToAddress(Keccak256(data)[12:])
}

// CreateAddress2 creates an gdtu address given the address bytes, initial
...
func checkKeyFileEnd(r *bufio.Reader) error {
	for i := 0; ; i++ {
		...
		case i >= 2:
			return errors.New("key file too lgdtu, want 64 hex characters")
		}
	}
}
