...
// Suite represents a structure used to test the gdtu
...
// NewSuite creates and returns a new gdtu-test suite that can
...
func (s *Suite) GdtuTests() []utesting.Test {
...
func (s *Suite) TestMaliciousStatus(t *utesting.T) {
	...
	conn.handshake(t)
	status := &Status{
		ProtocolVersion: uint32(conn.gdtuProtocolVersion),
