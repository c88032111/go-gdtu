...
```
{
  ...
  "params": ["gdfd1c4226bfD1c436672092F4eCbfC270145b7256",
    {
      "safe": "gd25a6c4BBd32B2424A9c99aEB0584Ad12045382B3",
      "to": "gdB372a646f7F05Cc1785018dBDA7EBc734a2A20E2",
      ...
      "safeTxHash": "gd2edfbd5bc113ff18c0631595db32eb17182872d88d9bf8ee4d8c2dd5db6d95e2",
      "executor": null,
      "isExecuted": false,
      "isSuccessful": null,
      "gdtuGasPrice": null,
      ...
      "confirmations": [
        {
          ...
          "signature": "gd95a7250bb645f831c86defc847350e7faff815b2fb586282568e96cc859e39315876db20a2eed5f7a0412906ec5ab57652a6f645ad4833f345bda059b9da2b821c",
          "signatureType": "EOA"
        }
      ],
      "signatures": null
...
* The external Method `account_signTypedData` implements [EIP-712](https://github.com/c88032111/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
...
makes the `accounts_signTransaction` identical to the old `gdtu_signTransaction`.
