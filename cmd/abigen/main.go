...
import (
	...
	"github.com/c88032111/go-gdtu/common/compiler"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Gdtu contract ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Gdtu contract bytecode (generate deploy Method)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the Gdtu contract Solidity source to build and bind",
	}
	...
	vyFlag = cli.StringFlag{
		Name:  "vy",
		Usage: "Path to the Gdtu contract Vyper source to build and bind",
	}
