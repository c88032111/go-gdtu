...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale gdtu state data based on the snapshot",
				ArgsUsage: "<root>",
...
All trie nodes and contract codes that do not belgdtu to the specified
...
during the use of Ggdtu, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
ggdtu snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
ggdtu snapshot traverse-rawstate <state-root>
