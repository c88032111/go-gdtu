...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Gdtu presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    ggdtu wallet import /path/to/my/presale.wallet

will prompt for your password and imports your gdtuer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Gdtu presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	ggdtu wallet [options] /path/to/my/presale.wallet
...
between gdtu nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    ggdtu account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    ggdtu account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another gdtu instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := ggdtuConfig{Node: defaultNodeConfig()}
	// Load config file.
