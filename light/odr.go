...
type OdrRequest interface {
	StoreResult(db gdtudb.Database)
}
...
// StateTrieID returns a TrieID for a state trie belgdtuing to a certain block
// header.
...
func (req *TrieRequest) StoreResult(db gdtudb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db gdtudb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db gdtudb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db gdtudb.Database) {
	if !req.Untrusted {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db gdtudb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db gdtudb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *TxStatusRequest) StoreResult(db gdtudb.Database) {}
