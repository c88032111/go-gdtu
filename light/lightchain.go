...
// available in the database. It initialises the default Gdtu header
// validator.
...
// retrieved while it is guaranteed that they belgdtu to the same version of the chain
