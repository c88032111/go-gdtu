...
// errNonCanonicalHash is returned if the requested chain data doesn't belgdtu
...
// GetBloomBits retrieves a batch of compressed bloomBits vectors belgdtuing to
