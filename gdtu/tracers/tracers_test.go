...
import (
	...
	"github.com/c88032111/go-gdtu/tests"
)

// To generate a new callTracer test, copy paste the makeTest Method below into
// a Ggdtu console and call it with a transaction hash you which to export.
...
var makeTest = function(tx, rewind) {
  ...
  var block   = gdtu.getBlock(gdtu.getTransaction(tx).blockHash);
  var genesis = gdtu.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.gdtu.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  gdtu.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
...
func TestPrestateTracerCreate2(t *testing.T) {
	unsignedTx := types.NewTransaction(1, common.HexToAddress("gd00000000000000000000000000000000deadbeef"),
	...
	*/
	...
	// the address
	alloc[common.HexToAddress("gd00000000000000000000000000000000deadbeef")] = core.GenesisAccount{
		Nonce:   1,
		Code:    hexutil.MustDecode("gd63deadbeef60005263cafebabe6004601c6000F560005260206000F3"),
	...
	if _, has := ret["gd60f3f640a8508fc6a86d45df051962668e1e8ac7"]; !has {
