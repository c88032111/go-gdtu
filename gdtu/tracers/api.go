...
// NewAPI creates a new API definition for the tracing Methods of the Gdtu service.
...
func (api *API) traceChain(ctx context.Context, start, end *types.Block, config *TraceConfig) (*rpc.Subscription, error) {
	// Tracing a chain is a **lgdtu** operation, only do with subscriptions
	...
	// lgdtu time. Timeout mechanism is necessary.
...
func (api *API) TraceCall(ctx context.Context, args gdtuapi.CallArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceConfig) (interface{}, error) {
...
func (api *API) traceTx(ctx context.Context, message core.Message, txctx *txTraceContext, vmctx vm.BlockContext, statedb *state.StateDB, config *TraceConfig) (interface{}, error) {
	...
	case *vm.StructLogger:
		...
		return &gdtuapi.ExecutionResult{
			Gas:         result.UsedGas,
			Failed:      result.Failed(),
			ReturnValue: returnVal,
			StructLogs:  gdtuapi.FormatLogs(tracer.StructLogs()),
		}, nil
