...
func makeChain(n int, seed byte, parent *types.Block) ([]common.Hash, map[common.Hash]*types.Block) {
	blocks, _ := core.GenerateChain(params.TestChainConfig, parent, gdtuash.NewFaker(), testdb, n, func(i int, block *core.BlockGen) {
...
type fetcherTester struct {
	...
	hashes  []common.Hash                 // Hash chain belgdtuing to the tester
	headers map[common.Hash]*types.Header // Headers belgdtuing to the tester
	blocks  map[common.Hash]*types.Block  // Blocks belgdtuing to the tester
...
func testPendingDeduplication(t *testing.T, light bool) {
	...
	headerWrapper := func(hash common.Hash) error {
		...
		// Simulate a lgdtu running fetch
		go func() {
			time.Sleep(delay)
			headerFetcher(hash)
		}()
...
func TestDistantPropagationDiscarding(t *testing.T) {
	// Create a lgdtu chain to import and define the discard boundaries
