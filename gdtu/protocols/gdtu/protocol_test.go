...
// TestGdtu66EmptyMessages tests encoding of empty gdtu66 messages
func TestGdtu66EmptyMessages(t *testing.T) {
...
// TestGdtu66Messages tests the encoding of all redefined gdtu66 messages
func TestGdtu66Messages(t *testing.T) {
