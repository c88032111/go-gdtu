...
// Peer is a collection of relevant information we have about a `gdtu` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `gdtu` protocol version.
...
// ReplyPooledTransactionsRLP is the gdtu/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the gdtu/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the gdtu/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the gdtu/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the gdtu/66 response to GetReceipts.
