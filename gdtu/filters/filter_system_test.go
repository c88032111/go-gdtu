...
func TestBlockSubscription(t *testing.T) {
	...
	var (
		...
		chain, _    = core.GenerateChain(params.TestChainConfig, genesis, gdtuash.NewFaker(), db, 10, func(i int, gen *core.BlockGen) {})
...
func TestPendingTxFilter(t *testing.T) {
	...
	var (
		...
		transactions = []*types.Transaction{
			types.NewTransaction(0, common.HexToAddress("gdb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(1, common.HexToAddress("gdb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(2, common.HexToAddress("gdb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(3, common.HexToAddress("gdb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(4, common.HexToAddress("gdb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
		}
...
func TestInvalidGetLogsRequest(t *testing.T) {
	var (
		...
		backend   = &testBackend{db: db}
		api       = NewPublicFilterAPI(backend, false, deadline)
		blockHash = common.HexToHash("gd1111111111111111111111111111111111111111111111111111111111111111")
	)
...
func TestLogFilter(t *testing.T) {
	...
	var (
		...
		firstAddr      = common.HexToAddress("gd1111111111111111111111111111111111111111")
		secondAddr     = common.HexToAddress("gd2222222222222222222222222222222222222222")
		thirdAddress   = common.HexToAddress("gd3333333333333333333333333333333333333333")
		notUsedAddress = common.HexToAddress("gd9999999999999999999999999999999999999999")
		firstTopic     = common.HexToHash("gd1111111111111111111111111111111111111111111111111111111111111111")
		secondTopic    = common.HexToHash("gd2222222222222222222222222222222222222222222222222222222222222222")
		notUsedTopic   = common.HexToHash("gd9999999999999999999999999999999999999999999999999999999999999999")
...
func TestPendingLogsSubscription(t *testing.T) {
	...
	var (
		...
		firstTopic     = common.HexToHash("gd1111111111111111111111111111111111111111111111111111111111111111")
		secondTopic    = common.HexToHash("gd2222222222222222222222222222222222222222222222222222222222222222")
		thirdTopic     = common.HexToHash("gd3333333333333333333333333333333333333333333333333333333333333333")
		fourthTopic    = common.HexToHash("gd4444444444444444444444444444444444444444444444444444444444444444")
		notUsedTopic   = common.HexToHash("gd9999999999999999999999999999999999999999999999999999999999999999")
		...
		testCases = []struct {
			...
			// match all
			{
				gdtu.FilterQuery{}, flattenLogs(allLogs),
				nil, nil,
			},
			// match none due to no matching addresses
			{
				gdtu.FilterQuery{Addresses: []common.Address{{}, notUsedAddress}, Topics: [][]common.Hash{nil}},
				nil,
				nil, nil,
			},
			// match logs based on addresses, ignore topics
			{
				gdtu.FilterQuery{Addresses: []common.Address{firstAddr}},
				append(flattenLogs(allLogs[:2]), allLogs[5][3]),
				nil, nil,
			},
			// match none due to no matching topics (match with address)
			{
				gdtu.FilterQuery{Addresses: []common.Address{secondAddr}, Topics: [][]common.Hash{{notUsedTopic}}},
				nil, nil, nil,
			},
			// match logs based on addresses and topics
			{
				gdtu.FilterQuery{Addresses: []common.Address{thirdAddress}, Topics: [][]common.Hash{{firstTopic, secondTopic}}},
				append(flattenLogs(allLogs[3:5]), allLogs[5][0]),
				nil, nil,
			},
			// match logs based on multiple addresses and "or" topics
			{
				gdtu.FilterQuery{Addresses: []common.Address{secondAddr, thirdAddress}, Topics: [][]common.Hash{{firstTopic, secondTopic}}},
			...
			{
				gdtu.FilterQuery{Addresses: []common.Address{firstAddr}, FromBlock: big.NewInt(2), ToBlock: big.NewInt(3)},
				append(flattenLogs(allLogs[:2]), allLogs[5][3]),
				nil, nil,
			},
			// multiple pending logs, should match only 2 topics from the logs in block 5
			{
				gdtu.FilterQuery{Addresses: []common.Address{thirdAddress}, Topics: [][]common.Hash{{firstTopic, fourthTopic}}},
...
func TestPendingTxFilterDeadlock(t *testing.T) {
	...
	go func() {
		...
		for {
			...
			tx := types.NewTransaction(i, common.HexToAddress("gdb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil)
