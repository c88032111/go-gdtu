...
// testHandler is a live implementation of the Gdtu protocol handler, just
...
func newTestHandlerWithBlocks(blocks int) *testHandler {
	...
	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), gdtuash.NewFaker(), db, blocks, nil)
