...
// 2.1.0 (Model T). The Gdtu address representation was changed from the 20
...
//go:generate protoc -I/usr/local/include:. --go_out=import_path=trezor:. messages.proto messages-common.proto messages-management.proto messages-gdtu.proto
//go:generate protoc --proto_path=/xxxxxx/go-gdtu/accounts/usbwallet/trezor --go_out=/xxxxx/go-gdtu/accounts/usbwallet/trezor/ messages.proto messages-common.proto messages-management.proto messages-gdtu.proto
