...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain gdtu.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to gdtu-type signature.
		signature[64] -= 27 // Transform V from Gdtu-legacy to 0/1
	}
