...
// "gd00Ce0d46d924CC8437c806721496599FC3FFA268", 2218516807680, "usd"
...
func TestEventTupleUnpack(t *testing.T) {
	...
	addr := common.HexToAddress("gd00Ce0d46d924CC8437c806721496599FC3FFA268")
	var testCases = []struct {
		...
		"Can not unpack Pledge event into slice with wrgdtu types",
	}, {
		pledgeData1,
		&BadEventPledge{},
		&BadEventPledge{},
		...
		"Can not unpack Pledge event into struct with wrgdtu filed types",
	}, {
		pledgeData1,
