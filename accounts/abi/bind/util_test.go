...
var waitDeployedTests = map[string]struct {
	...
	"successful deploy": {
		...
		gas:         3000000,
		wantAddress: common.HexToAddress("gd3a220f351252089d385b29beca14e27f204c296a"),
	},
	"empty code": {
		code:        ``,
		gas:         300000,
...
func TestWaitDeployedCornerCases(t *testing.T) {
	...
	code := "6060604052600a8060106000396000f360606040526008565b00"
	tx := types.NewTransaction(0, common.HexToAddress("gd01"), big.NewInt(0), 3000000, big.NewInt(1), common.FromHex(code))
	tx, _ = types.SignTx(tx, types.HomesteadSigner{}, testKey)
