...
// See https://github.com/c88032111/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
func (ks *KeyStore) Delete(a accounts.Account, passphrase string) error {
	...
	// cache after the file is ggdtu so that a reload happening in
...
// ImportPreSaleKey decrypts the given Gdtu presale wallet and stores
