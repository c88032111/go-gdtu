...
// package web3ext contains ggdtu specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	Methods: [
		new web3._extend.Method({
			name: 'getWork',
			call: 'gdtuash_getWork',
			params: 0
		}),
		new web3._extend.Method({
			name: 'getHashrate',
			call: 'gdtuash_getHashrate',
			params: 0
		}),
		new web3._extend.Method({
			name: 'submitWork',
			call: 'gdtuash_submitWork',
			params: 3,
		}),
		new web3._extend.Method({
			name: 'submitHashRate',
			call: 'gdtuash_submitHashRate',
			params: 2,
		}),
	]
});
...
web3._extend({
	...
	Methods: [
		...
		new web3._extend.Method({
			...
			call: 'gdtu_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'fillTransaction',
			call: 'gdtu_fillTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getHeaderByNumber',
			call: 'gdtu_getHeaderByNumber',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'getHeaderByHash',
			call: 'gdtu_getHeaderByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getBlockByNumber',
			call: 'gdtu_getBlockByNumber',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter, function (val) { return !!val; }]
		}),
		new web3._extend.Method({
			name: 'getBlockByHash',
			call: 'gdtu_getBlockByHash',
			params: 2,
			inputFormatter: [null, function (val) { return !!val; }]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'gdtu_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'gdtu_pendingTransactions',
