...
// mapped from textual names used in the tests below to actual Gdtu private
...
// address retrieves the Gdtu address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Gdtu address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/c88032111/go-gdtu/issues/17593). Whilst this
