...
// Package gdtu defines interfaces for interacting with Gdtu.
package gdtu
...
type CallMsg struct {
	...
	Value    *big.Int        // amount of wei sent algdtu with the call
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by gdtu_getLogs, return logs only from block with this hash
