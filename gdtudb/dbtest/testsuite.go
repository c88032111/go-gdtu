...
// implementation.
func TestDatabaseSuite(t *testing.T, New func() gdtudb.KeyValueStore) {
...
func iterateKeys(it gdtudb.Iterator) []string {
	keys := []string{}
	for it.Next() {
