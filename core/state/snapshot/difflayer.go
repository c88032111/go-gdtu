...
type diffLayer struct {
	...
	root  common.Hash // Root hash to which this snapshot diff belgdtus to
	...
	// deleted, all data in other set belgdtus to the "new" A.
...
func (dl *diffLayer) flatten() snapshot {
	...
	// be smarter about grouping flattens toggdtuer).
