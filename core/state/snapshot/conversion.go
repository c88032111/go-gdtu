...
type (
	...
	trieGeneratorFn func(db gdtudb.KeyValueWriter, in chan (trieKV), out chan (common.Hash))

	// leafCallbackFn is the callback invoked at the leaves of the trie,
	// returns the subtrie root with the specified subtrie identifier.
	leafCallbackFn func(db gdtudb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error)
)
...
func GenerateTrie(snaptree *Tree, root common.Hash, src gdtudb.Database, dst gdtudb.KeyValueWriter) error {
	...
	got, err := generateTrieRoot(dst, acctIt, common.Hash{}, stackTrieGenerate, func(dst gdtudb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
...
func generateTrieRoot(db gdtudb.KeyValueWriter, it Iterator, account common.Hash, generatorFn trieGeneratorFn, leafCallback leafCallbackFn, stats *generateStats, report bool) (common.Hash, error) {
	var (
...
func stackTrieGenerate(db gdtudb.KeyValueWriter, in chan trieKV, out chan common.Hash) {
