...
// Package state provides a caching layer atop the Gdtu state trie.
package state
...
// StateDB structs within the gdtu protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/c88032111/go-gdtu/pull/16485#issuecomment-380438527),
