...
// account array.
func checkStateAccounts(t *testing.T, db gdtudb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db gdtudb.Database, root common.Hash) error {
...
func checkStateConsistency(db gdtudb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(gdtudb.Database), srcRoot)
