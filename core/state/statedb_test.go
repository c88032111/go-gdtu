...
// https://github.com/c88032111/go-gdtu/pull/15549.
...
// See https://github.com/c88032111/go-gdtu/pull/15225#issuecomment-380191512
...
//
// See https://github.com/c88032111/go-gdtu/issues/20106.
func TestCopyCommitCopy(t *testing.T) {
	state, _ := New(common.Hash{}, NewDatabase(rawdb.NewMemoryDatabase()), nil)

	// Create an account and check if the retrieved balance is correct
	addr := common.HexToAddress("gdaffeaffeaffeaffeaffeaffeaffeaffeaffeaffe")
