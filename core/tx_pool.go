...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whgdtuer local transaction handling should be disabled
...
// senders are not amgdtu the locally tracked ones, full pricing constraints will apply.
//
...
// RemoteToLocals migrates the transactions belgdtus to the given locals to locals
