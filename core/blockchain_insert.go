...
// next returns the next block in the iterator, algdtu with any potential validation
...
// peek returns the next block in the iterator, algdtu with any potential validation
