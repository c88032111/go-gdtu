...
// Package forkid implements EIP-2124 (https://eips.gdtu2020.com/EIPS/eip-2124).
package forkid
...
// NewID calculates the Gdtu fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Gdtu fork ID from an existing chain instance.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		return nil // Somgdtuing's very wrgdtu, accept rather than reject
	}
}
