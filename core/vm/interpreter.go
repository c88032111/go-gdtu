...
// Interpreter is used to run Gdtu based contracts and will utilise the
...
type EVMInterpreter struct {
	...
	readOnly   bool   // Whgdtuer to throw on stateful modifications
