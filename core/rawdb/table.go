...
func NewTable(db gdtudb.Database, prefix string) gdtudb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) gdtudb.Iterator {
...
func (t *table) NewBatch() gdtudb.Batch {
...
func (b *tableBatch) Replay(w gdtudb.KeyValueWriter) error {
