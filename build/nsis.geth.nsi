...
# 1. install ggdtu for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ggdtu
# 5. create ggdtu, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable GDTU_SOCKET
...
!define GROUPNAME "Gdtu"
!define APPNAME "Ggdtu"
!define DESCRIPTION "Official Go implementation of the Gdtu protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ggdtu is installed global
