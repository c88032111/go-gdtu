Name "ggdtu ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/c88032111/go-gdtu/issues"
!define UPDATEURL "https://github.com/c88032111/go-gdtu/releases"
!define ABOUTURL "https://github.com/c88032111/go-gdtu#gdtu-go"
...
# Install ggdtu binary
Section "Ggdtu" GGDTU_IDX
  SetOutPath $INSTDIR
  file {{.Ggdtu}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ggdtu.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ggdtu.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Ggdtu incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ggdtu outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ggdtu UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Ggdtu incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ggdtu.exe" "" "" "Gdtu" 30303 "" "" ""
  SimpleFC::AdvAddRule "Ggdtu outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ggdtu.exe" "" "" "Gdtu" "" 30303 "" ""
  SimpleFC::AdvAddRule "Ggdtu UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ggdtu.exe" "" "" "Gdtu" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/c88032111/EIPs/issues/147)
  ${EnvVarUpdate} $0 "GDTU_SOCKET" "R" "HKLM" "\\.\pipe\ggdtu.ipc"
  ${EnvVarUpdate} $0 "GDTU_SOCKET" "A" "HKLM" "\\.\pipe\ggdtu.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GGDTU_IDX}
    SectionGetSize ${GGDTU_IDX} $0
  ...
  IntFmt $GetInstalledSize.total "gdtu%08X" $GetInstalledSize.total
