...
// Package tests implements execution of Gdtu JSON tests.
package tests
...
/* See https://github.com/c88032111/tests/wiki/Blockchain-Tests-II

   Whgdtuer a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validateImportedHeaders(cm *core.BlockChain, validBlocks []btBlock) error {
	...
	// be part of the lgdtuest chain until last block is imported.
