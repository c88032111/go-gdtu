...
import (
	...
	l "github.com/c88032111/go-gdtu/les"
...
var (
	...
	bankFunds  = new(big.Int).Mul(big.NewInt(100), big.NewInt(params.Gdtur))
...
func makechain() (bc *core.BlockChain, addrHashes, txHashes []common.Hash) {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, gdtuash.NewFaker(), db, testChainLen,
	...
	bc, _ = core.NewBlockChain(db, nil, gspec.Config, gdtuash.NewFaker(), vm.Config{}, nil, nil)
