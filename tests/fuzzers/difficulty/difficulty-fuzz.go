...
func (f *fuzzer) fuzz() int {
	...
	for i, pair := range []struct {
		...
		{gdtuash.FrontierDifficultyCalulator, gdtuash.CalcDifficultyFrontierU256},
		{gdtuash.HomesteadDifficultyCalulator, gdtuash.CalcDifficultyHomesteadU256},
		{gdtuash.DynamicDifficultyCalculator(bombDelay), gdtuash.MakeDifficultyCalculatorU256(bombDelay)},
	} {
