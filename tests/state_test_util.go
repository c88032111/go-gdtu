...
// See https://github.com/c88032111/EIPs/issues/176 for the test format specification.
...
func MakePreState(db gdtudb.Database, accounts core.GenesisAlloc, snapshotter bool) (*snapshot.Tree, *state.StateDB) {
